...
<body class="bg-gray-100 text-gray-800 min-h-screen">
  ...
  <nav class="w-full bg-white shadow-sm px-10 py-4 flex justify-between items-center sticky top-0 z-10 border-b">
    ...
    <ul class="flex gap-8 text-lg font-medium">
      <li>
        <button onclick="showSection('dashboard')" class="nav-btn px-3 py-1 rounded-lg bg-primary text-white active">
          Dashboard
        </button>
      </li>
      <li>
        <button onclick="showSection('cours')" class="nav-btn px-3 py-1 rounded-lg hover:bg-blue-100 transition">
          Cours
        </button>
      </li>
      <li>
        <button onclick="showSection('equipements')" class="nav-btn px-3 py-1 rounded-lg hover:bg-blue-100 transition">
          Équipements
        </button>
      </li>
      <li>
        <button onclick="showSection('parametres')" class="nav-btn px-3 py-1 rounded-lg hover:bg-blue-100 transition">
          Paramètres
        </button>
      </li>
    </ul>
  ...
  <main class="p-10">
    ...
    <div id="dashboard-section" class="content-section">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        <div class="bg-white p-8 rounded-xl shadow text-center border transition-transform hover:-translate-y-2">
        ...
        <table class="w-full text-left">
          ...
          <tbody>
            <tr class="border-b hover:bg-gray-50">
              ...
              <td class="px-4">
                <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">Yoga</span>
              </td>
              ...
              <td class="px-4 space-x-3">
                <button class="px-4 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Modifier</button>
                <button class="px-4 py-1 bg-red-500 text-white rounded-lg hover:bg-red-400 transition">Supprimer</button>
              </td>
            </tr>
            ...
            <tr class="border-b hover:bg-gray-50">
              ...
              <td class="px-4">
                <span class="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">Musculation</span>
              </td>
            ...
            <tr class="border-b hover:bg-gray-50">
              ...
              <td class="px-4">
                <span class="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">Cardio</span>
              </td>
    ...
    <div id="cours-section" class="content-section hidden">
      <div class="bg-white p-8 rounded-xl shadow border">
        <div class="flex justify-between items-center mb-6 pb-4 border-b-2 border-gray-100">
          ...
          <button onclick="openModal('coursModal')" class="px-6 py-3 bg-primary text-white rounded-lg transition-all hover:bg-secondary">
            ➕ Ajouter un Cours
          </button>
        </div>
          ...
          <table class="w-full text-left">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th class="px-4 py-4 text-left text-sm font-semibold text-primary uppercase">Catégorie</th>
                ...
                <th class="px-4 py-4 text-left text-sm font-semibold text-primary uppercase">Participants Max</th>
                <th class="px-4 py-4 text-left text-sm font-semibold text-primary uppercase">Actions</th>
              </tr>
            </thead>
            <tbody>
              <tr class="border-b hover:bg-gray-50">
                <td class="px-4 py-4 text-gray-600">Yoga du Matin</td>
                <td class="px-4 py-4">
                  <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">Yoga</span>
                </td>
                <td class="px-4 py-4 text-gray-600">2025-01-15</td>
                <td class="px-4 py-4 text-gray-600">08:00</td>
                <td class="px-4 py-4 text-gray-600">60 min</td>
                <td class="px-4 py-4 text-gray-600">20</td>
                <td class="px-4 py-4">
              ...
              <tr class="border-b hover:bg-gray-50">
                <td class="px-4 py-4 text-gray-600">Cardio Intensif</td>
                <td class="px-4 py-4">
                  <span class="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">Cardio</span>
                </td>
                <td class="px-4 py-4 text-gray-600">2025-01-15</td>
                <td class="px-4 py-4 text-gray-600">10:00</td>
                <td class="px-4 py-4 text-gray-600">45 min</td>
                <td class="px-4 py-4 text-gray-600">15</td>
                <td class="px-4 py-4">
                  <div class="flex gap-2">
                    <button class="px-4 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Modifier</button>
                    <button class="px-4 py-1 bg-red-500 text-white rounded-lg hover:bg-red-400 transition">Supprimer</button>
              ...
              <tr class="border-b hover:bg-gray-50">
                <td class="px-4 py-4 text-gray-600">Musculation Avancée</td>
                <td class="px-4 py-4">
                  <span class="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">Musculation</span>
                </td>
                <td class="px-4 py-4 text-gray-600">2025-01-15</td>
                <td class="px-4 py-4 text-gray-600">18:00</td>
                <td class="px-4 py-4 text-gray-600">90 min</td>
                <td class="px-4 py-4 text-gray-600">12</td>
                <td class="px-4 py-4">
                  <div class="flex gap-2">
                    <button class="px-4 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Modifier</button>
                    <button class="px-4 py-1 bg-red-500 text-white rounded-lg hover:bg-red-400 transition">Supprimer</button>
    ...
    <div id="equipements-section" class="content-section hidden">
      <div class="bg-white p-8 rounded-xl shadow border">
        <div class="flex justify-between items-center mb-6 pb-4 border-b-2 border-gray-100">
          ...
          <button onclick="openModal('equipementModal')" class="px-6 py-3 bg-primary text-white rounded-lg transition-all hover:bg-secondary">
          ...
          <table class="w-full text-left">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th class="px-4 py-4 text-left text-sm font-semibold text-primary uppercase">Quantité</th>
            ...
            <tbody>
              <tr class="border-b hover:bg-gray-50">
                ...
                <td class="px-4 py-4">
                  <span class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">Bon</span>
                </td>
                <td class="px-4 py-4">
                  <div class="flex gap-2">
                    <button class="px-4 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Modifier</button>
              ...
              <tr class="border-b hover:bg-gray-50">
                ...
                <td class="px-4 py-4">
                  <span class="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">Moyen</span>
                </td>
                <td class="px-4 py-4">
                  <div class="flex gap-2">
                    <button class="px-4 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Modifier</button>
              ...
              <tr class="border-b hover:bg-gray-50">
                ...
                <td class="px-4 py-4">
                  <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-medium">À remplacer</span>
                </td>
                <td class="px-4 py-4">
                  <div class="flex gap-2">
                    <button class="px-4 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Modifier</button>
      ...
      <div class="bg-white p-8 rounded-xl shadow border">
        ...
        <div class="space-y-4">
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <button class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Configurer</button>
          </div>
          <div class="bg-gray-50 p-4 rounded-lg">
            <h3 class="font-semibold text-lg mb-2">Compte</h3>
            <p class="text-gray-600 mb-2">Modifier les informations du compte</p>
            <button class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Modifier</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="coursModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center">
    <div class="bg-white p-8 rounded-xl max-w-2xl w-11/12 max-h-screen overflow-y-auto">
      <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="closeModal('coursModal')" class="text-3xl text-gray-400 hover:text-gray-800 border-0 bg-transparent">×</button>
      </div>
      <form>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div class="flex flex-col">
            <label class="mb-2 text-gray-600 font-medium text-sm">Nom du Cours *</label>
            <input type="text" placeholder="Ex: Yoga du Matin" required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          </div>
          <div class="flex flex-col">
            <label class="mb-2 text-gray-600 font-medium text-sm">Catégorie *</label>
            <select required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          ...
          <div class="flex flex-col">
            ...
            <input type="date" required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          </div>
          <div class="flex flex-col">
            <label class="mb-2 text-gray-600 font-medium text-sm">Heure *</label>
            <input type="time" required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          </div>
          <div class="flex flex-col">
            <label class="mb-2 text-gray-600 font-medium text-sm">Durée (minutes) *</label>
            <input type="number" placeholder="60" required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          </div>
          <div class="flex flex-col">
            <label class="mb-2 text-gray-600 font-medium text-sm">Participants Max *</label>
            <input type="number" placeholder="20" required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          </div>
        </div>
        <div class="mt-6 text-right">
          <button type="button" onclick="closeModal('coursModal')" class="mr-3 px-5 py-2 bg-red-100 text-red-700 rounded-md transition-all hover:bg-red-700 hover:text-white">
            Annuler
          </button>
          <button type="submit" class="px-6 py-3 bg-primary text-white rounded-lg transition-all hover:bg-secondary">
            Enregistrer
          </button>
        </div>
      </form>
  ...
  <div id="equipementModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center">
    <div class="bg-white p-8 rounded-xl max-w-2xl w-11/12 max-h-screen overflow-y-auto">
      <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="closeModal('equipementModal')" class="text-3xl text-gray-400 hover:text-gray-800 border-0 bg-transparent">×</button>
      </div>
      <form>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div class="flex flex-col">
            <label class="mb-2 text-gray-600 font-medium text-sm">Nom de l'Équipement *</label>
            <input type="text" placeholder="Ex: Tapis de Course" required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          </div>
          <div class="flex flex-col">
          ...
          <div class="flex flex-col">
            ...
            <input type="number" placeholder="10" required class="px-3 py-3 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
          </div>
          <div class="flex flex-col">
        ...
        <div class="mt-6 text-right">
          <button type="button" onclick="closeModal('equipementModal')" class="mr-3 px-5 py-2 bg-red-100 text-red-700 rounded-md transition-all hover:bg-red-700 hover:text-white">
            Annuler
          </button>
          <button type="submit" class="px-6 py-3 bg-primary text-white rounded-lg transition-all hover:bg-secondary">
            Enregistrer
